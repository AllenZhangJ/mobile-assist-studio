...
- 读取最新 V4 final acceptance 报告的脱敏摘要，为 Monitor 提供终验状态、Batch 0-8 进度、iOS / Android 留档数量、Android 本机状态、结构化终验门禁、现场补验清单和下一步；不暴露报告路径、stdout、stderr 或截图内容，补验命令只保留项目内 V4 smoke / 终验白名单。
