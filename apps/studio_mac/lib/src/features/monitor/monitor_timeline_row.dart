...
class _RunNodeTraceRowState extends State<_RunNodeTraceRow> {
  ...
  void initState() {
    ...
    _expanded =
        (widget.focused || widget.revealEvidenceByDefault) &&
        screenshotPath != null;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: widget.focused ? const EdgeInsets.all(10) : EdgeInsets.zero,
      decoration: widget.focused
          ? BoxDecoration(
              color: StudioColors.cyan.withValues(alpha: 0.08),
              border: Border.all(color: StudioColors.cyan),
          ...
          Row(
            children: [
              ...
              if (widget.focused) ...[
                ...
                const StatusPill(
                  key: ValueKey('run-trace-focused'),
                  label: '已定位',
