...
- 读取最新 V4 final acceptance 报告的脱敏摘要，为 Monitor 提供终验状态、iOS / Android 留档数量、Android 本机状态和下一步；不暴露报告路径、stdout、stderr 或截图内容。
...
- `runtime_v4_acceptance_models.dart`：最新 V4 final acceptance 脱敏摘要。
